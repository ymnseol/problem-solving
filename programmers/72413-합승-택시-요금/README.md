...
1. 두 사람이 합승하지 않고 따로 택시에 탑승해 각 목적지로 갈 때의 택시요금의 합과 모든 지점에 대해 두 사람이 해당 지점까지 합승을 하고, 해당 지점에서 따로 택시에 탑승해 각자 목적지에 도달했을 때의 택시 요금의 합 중 가장 적은 택시 요금을 반환합니다.